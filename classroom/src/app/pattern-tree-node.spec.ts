...
describe('PatternTreeNode', () => {
  ...
  it('should set data', () => {
    ...
    const ptl = new PatternTreeNode({label: 'Dead Leaf', id: 'dl', help: 'It is also dead, Jim'}, [], [pattern]);
    const ptn = new PatternTreeNode({label: 'Dead Tree', id: 'dt', help: 'It\'s dead, Jim'}, [ptl], []);
