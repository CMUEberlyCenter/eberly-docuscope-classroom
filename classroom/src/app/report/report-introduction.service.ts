...
export class ReportIntroductionService {
  ...
  getIntroductionText(): Observable<IntroductionText> {
    return this.http.get<IntroductionText>(this._assets_intro).pipe(
      catchError(err => of(DefaultIntroduction))
    );
  }
}
